...
public interface AlumnoMapper {
    ...
    @Mapping(source = "gradoCreateDTO" , target = "grado")
    @Mapping(source = "cursosCreateDTO" , target = "cursos")
    @Mapping(source = "salonDTO" , target = "salon")
    Alumno crearAlumno (AlumnoCreateDTO alumnoCreat);

    @Mapping(source = "gradoUpdateDTO" , target = "grado")
    @Mapping(source = "cursosUpdateDTO" , target = "cursos")
    @Mapping(source = "salonDTO" , target = "salon")
